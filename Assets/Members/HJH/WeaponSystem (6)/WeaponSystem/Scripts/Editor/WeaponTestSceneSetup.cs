...
namespace RobotWeapons.Editor
{
    public class WeaponTestSceneSetup : EditorWindow
    {
        ...
        private void SetupScene()
        {
            ...
            if (selectedChampion == Champion.MainDealer_Gun || selectedChampion == Champion.MainDealer_Laser)
            {
        ...
        private void CreateTestCamera(GameObject aimOrigin)
        {
            ...
            aimOrigin.AddComponent<CinemachineCamera>();
